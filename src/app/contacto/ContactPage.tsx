...
export default function ContactPage({ data }: { data: any }) {
  ...
  const whatsappUrl = `https://wa.me/543814463243?text=${encodeURIComponent(form.whatsappMessage || 'Hola! Me gustaria hablar sobre mi proyecto')}`
        ...
        <section className="py-16 sm:py-24 bg-brand-900">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <FadeIn>
              ...
              <p className="text-brand-400 text-sm mb-8">{form.description}</p>

              <a
                href={whatsappUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-[#25D366] text-white px-12 py-5 text-base font-bold tracking-wider hover:bg-[#20bd5a] transition-all hover:scale-105"
              >
