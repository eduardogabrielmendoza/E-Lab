...
export default function CTASection({ data }: { data: any }) {
  const cta = data
  const isExternal = cta.button.href.startsWith('http')
        ...
        <SlideUp delay={0.2}>
          {isExternal ? (
            <a
              ...
              className="inline-flex items-center gap-2 mt-8 bg-[#25D366] text-white px-10 py-4 text-sm font-bold tracking-wider hover:bg-[#20bd5a] transition-all hover:scale-105"
            >
